...
net_hed = cv2.dnn.readNet(cv2.samples.findFile(prototxt_path), cv2.samples.findFile(caffemodel_path))
    ...
    def load_edge(self, img, img_ori, index, mask):
        ...
        # external
            ...
            if len(self.edge_data) != 0:
                ...
                inp = cv2.dnn.blobFromImage(frame, scalefactor=1.0, size=(width, height),mean=(104.00698793, 116.66876762, 122.67891434),swapRB=False, crop=False)
